...
import com.sunyu.chatgpt.application.IWeiXinValidateService;
import com.sunyu.chatgpt.domain.model.MessageTextEntity;
import com.sunyu.chatgpt.infrastracture.util.XmlUtil;
...
public class WeiXinPortalController {
    ...
    @Value("${wx.config.originalid:gh_e851d0f4790c}")
    ...
    public WeiXinPortalController() {
        ...
        configuration.setAuthToken("eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ4ZmciLCJleHAiOjE3MDUyNzgxNDYsImlhdCI6MTcwNTI3Nzg0NiwianRpIjoiYTRmMWFlYmEtYWZlOC00ODdkLWI4NmEtNDc5MjM5YTlhMzdjIiwidXNlcm5hbWUiOiJ4ZmcifQ.Y5x9qKMdvCQnP4jZLE88lGUNmD0SF4Y0h8B2u_lPk08");
        // 2. 会话工厂
